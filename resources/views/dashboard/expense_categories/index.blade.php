...
<div class="tab-content" id="myTabContent">
  ...
  @php $counter = 1; @endphp
    ...
    <td>
    <a href="#" class="danger" data-toggle="modal" data-target="#DeleteExpCategories{{$expense_category->id}}" data-whatever="@mdo"><i class="fa fa-trash text-danger"></i></a>
     @include('dashboard.expense_categories.delete')
  ...
  <form action="{{route('category_expence.store')}}" method="POST">
        @csrf
          ...
          <div class="form-group pt-2">
            <input type="submit" class="btn btn-primary form-control " value="Add Expense Category"> 
            </div>
